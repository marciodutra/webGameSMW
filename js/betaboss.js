...
function iniciarJogo() {
  ...
  const playaudio = document.querySelector(".bossmusic");
  playaudio.volume = 1;
  playaudio.play();
  ...
  function updatePosition() {
    ...
    keys.forEach((code) => {
      if (code === "ArrowLeft") {
        ...
        const maxMarioPosition = cenarioContainerWidth * 0.85 - marioWidth;
        marioPosition += marioSpeed;
...
function simularEventoTecla(code) {
  ...
  document.querySelector(".boss").classList.add("boss-start");
  ...
  document.querySelector(".bossaRight").classList.add("bossaRight-start");
  document.querySelector(".bossaLeft").classList.add("bossaLeft-start");
  ...
  countdown = setInterval(function () {
    ...
    if (timeLeft === 100) {
      ...
      const audioold = document.querySelector(".bossmusic");
      const audionew = document.querySelector(".bossmusica");
      audio.play();
      setTimeout(() => {
        audio.pause();
        audioold.volume = 0;
  ...
  let mariob = document.querySelector(".mario");
  ...
  function checkCollision() {
    ...
    if (
      ...
      const collectcImg = document.getElementById("collectall");
      collectcImg.classList.add("collectc");
      collectcImg.style.display = "block";
      collectcImg.style.zIndex = 99;
      collectcImg.style.position = "absolute";
